...
func main() {
	...
	iterationBatch(conn, "2023-08-01 00:00:00", "2023-08-31 00:00:00")
...
func iterationBatch(db driver.Conn, startDateTime, stopDateTime string) {

	d := dateSeq1day(startDateTime, stopDateTime)
